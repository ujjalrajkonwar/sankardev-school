    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 pt-24 pb-16 sm:pt-32 sm:pb-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Premium Profile Section - Top 2 Teachers */}
          <div className="mb-16">
            <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-8 max-w-3xl mx-auto mb-12">
              
              {/* Teacher 1 Premium Card */}
          ...
          {isLoaded && categories.length > 0 && (
            <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 mb-12 max-w-4xl mx-auto">
              {categories.map((cat) => (
                <button
                  key={cat}
          ...
          {/* Teachers Grid - Responsive 2 on mobile, 6 on desktop */}
          <div className="grid grid-cols-2 lg:grid-cols-6 gap-3 sm:gap-4 md:gap-6 text-left">
            {filteredTeachers.map((teacher) => (
              <div key={teacher.id} className="bg-white rounded-xl p-2 sm:p-3 border border-gray-100 shadow-sm hover:shadow-md transition-shadow group flex flex-col items-center">
                 ...
                 {/* Photo Area - auto-adjust to photo size */}
